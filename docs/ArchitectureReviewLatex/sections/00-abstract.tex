...
\code{20eca72} --- what the program can do today, how its layers fit together, and where
...
diagnostics around a hang-proof run loop, XML design persistence, and a 34-command
...
lags furthest behind the core: it now shows the part tree live and opens and saves
\code{.qrd} designs, but rocket \emph{authoring} --- adding, removing, or editing parts ---
is still possible only from the CLI.
