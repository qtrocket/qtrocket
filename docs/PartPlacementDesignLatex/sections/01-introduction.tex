...
convention (\zfwd, toward the nose tip), including the one frame collision --- the cone's internal
CM frame --- that must be reconciled explicitly. \Cref{sec:datamodel} gives the exact C++ value types
