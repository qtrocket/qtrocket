...
\subsection*{The knobs, listed}

\input{transcripts/tut4-block1}
...
low flights and progressively more as you climb; knowing \emph{when} a better
model matters is as useful as having it.

\subsection*{No air at all: the vacuum ceiling}

\input{transcripts/tut4-block4}
...
across the sharp thrust transient. The lesson generalizes: when a result
matters, halve the timestep and see if the answer moves.

\subsection*{Tilt the rail}

\input{transcripts/tut4-block7}
...
have a measurable price; and the launch rail's speed and angle are the last
