...
\input{transcripts/tut2-block3}

Each rung is the same three commands: \repl{setmotor}, \repl{launch},
...
Same silhouette all day --- only the motor changed.}{fig:motor-lab}{0.78}
...
next \repl{launch} overwrites it; \repl{savedb} persists the merged pool.
\end{tip}
